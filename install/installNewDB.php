...
$validKeys = array("databasetype","databasehost",
                   ...
                   "databaselogincreated", "databaseloginname","databaseloginpassword",
...
$db_created = trim($_SESSION['databaselogincreated']);
...
if (!$db_created) {
  ...
  if( $conn_result['status'] == 0 && $_SESSION['createdb'] !== true)  {
