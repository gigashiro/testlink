...
<div class="tlStory">
  ...
  <script language="JavaScript">
    function toggleDbLogin() {
      var f = document.myForm;
      var checked = f.databaselogincreated.checked
      f.databaseloginname.disabled = checked
      f.databaseloginpassword.disabled = checked
    }
    ...
    function validate() {
      ...
      if(!f.databaselogincreated.checked && f.databaseloginname.value=="") {
...
<?php } ?>
    ...
    <select id="databasetype" name="databasetype">
      <option value="mysql" <?php echo getenv('DB_TYPE') == 'mysql' ? 'selected' : ''; ?>>MySQL/MariaDB (5.6+ / 10.+)</option>
      <option value="postgres" <?php echo getenv('DB_TYPE') == 'postgres' ? 'selected' : ''; ?>>Postgres (9.1 and later)</option>
      <option value="mssql" <?php echo getenv('DB_TYPE') == 'mssql' ? 'selected' : ''; ?>>Microsoft SQL Server 2008 and later (Experimental)</option>
    </select> 
    </p>
    <p>
      <div class="labelHolder">
      ...
      <input type="text" id="databasehost" name="databasehost" 
                        value="<?php echo getenv('DB_HOST'); ?>" style="width:200px" />
    </p>
    <p>
    ...
    <input type="text" id="databasename" name="databasename"  maxlength="50" 
                 style="width:200px" value="<?php echo getenv('DB_NAME'); ?>">
    </p>
    <?php if($_SESSION['isNew']){ ?>
    <p>
    ...
    <p>
      <div class="labelHolder"><label for="databaselogincreated">Testlink DB exists?</label></div>
      <input type="checkbox" id="databaselogincreated" name="databaselogincreated" checked="true" style="width:200px" onClick="javascript: toggleDbLogin()" /><br />
      <div class="labelHolder"><label for="databaseloginname">Database admin login</label></div>
      <input type="text" id="databaseloginname" name="databaseloginname" disabled="true" style="width:200px" /><br />
      <div class="labelHolder"><label for="databaseloginpassword">Database admin password</label></div>
      <input type="password" id="databaseloginpassword" name="databaseloginpassword" disabled="true" style="width:200px" /><br />
    </p>
    <p>
    <div class="tlBox">
    ...
    <p>Define database User for Testlink access:</p>
      ...
      <input type="text" id="tl_loginname" name="tl_loginname" value="<?php echo getenv('DB_USER'); ?>" style="width:200px" /><br />
          
      <div class="labelHolder">
        <label for="tl_loginpassword">TestLink DB password</label>
      </div>
      <input type="password" id="tl_loginpassword" name="tl_loginpassword" value="<?php echo getenv('DB_PASS'); ?>" style="width:200px" /><br />
    </p>
    <p>
    <div class="tlBox">
